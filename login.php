            ...
            <div class="col-sm-4">
                ...
                <div class="card">
                    <div class="card-header" style="background: #323232;">
                        <h4 class="card-title" style="color: #ffff; text-align: center;">Halaman Login</h4>
                    </div>
                    <div class="card-body" style="background:#ffac41;">
						<!-- form berfungsi mengirimkan data input 
						dengan method post ke proses login dengan paramater get aksi login -->
                        <form method="post" action="functions/crud.php?aksi=login" id="formlogin">
